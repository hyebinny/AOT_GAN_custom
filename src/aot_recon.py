...
# ------------------ paths ------------------
# # EWHA_BED dataset
# IMG_DIR = "/mnt/d/Hyebin/AOT-GAN-for-Inpainting/aot-gan_intermediate_recon_results/ewha_orig"
# MASK_DIR = "/mnt/d/Hyebin/AOT-GAN-for-Inpainting/aot-gan_intermediate_recon_results/ewha_mask/random_rec"
# OUT_DIR = "/mnt/d/Hyebin/AOT-GAN-for-Inpainting/aot-gan_intermediate_recon_results/500_000/ewha/random_rec"
# PRE_TRAIN = "/mnt/d/hyebin/AOT-GAN-for-Inpainting/experiments/slp/aotgan_slp_train_random_rec256/G0500000.pt"

# SLP dataset
IMG_DIR = "/mnt/d/Hyebin/AOT-GAN-for-Inpainting/aot-gan_intermediate_recon_results/slp_orig"
MASK_DIR = "/mnt/d/Hyebin/AOT-GAN-for-Inpainting/aot-gan_intermediate_recon_results/slp_mask/random_rec"
OUT_DIR = "/mnt/d/Hyebin/AOT-GAN-for-Inpainting/aot-gan_intermediate_recon_results/500_000/slp/random_rec"
PRE_TRAIN = "/mnt/d/hyebin/AOT-GAN-for-Inpainting/experiments/slp/aotgan_slp_train_random_rec256/G0500000.pt"
...
def main():
    ...
    with torch.no_grad():
        for p in img_paths:
            ...
            # 학습/마스크가 256 기반이면 보통 둘 다 256임. 다르면 mask 기준으로 맞춤.
            ...
            # ---- inpaint (trainer와 동일) ----
            # images_masked = images*(1-mask) + mask (mask 영역을 1로 채움)
